...
def gui():
    ...
    class App(tk.Tk):
        def __init__(self):
            ...
            from app_config import translation_mode
            self.provider_label = ttk.Label(translation, text='Free OpenRouter' if translation_mode() == 'free' else DEEPSEEK_LABEL)
            ...
            self.translate_button = ttk.Button(translation, text='Translate', command=self.translate)
            ...
            ttk.Label(right, text='Uses your saved translation mode and API key. Change models in the main window.').pack(anchor='w')
